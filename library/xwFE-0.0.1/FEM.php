...
<form class="navbar-form navbar-left" role="search" style="margin-top:11px" ng-submit="gosearch(searchParam,0)"><div class="form-group"><input ng-model="searchParam" type="search" class="form-control input-sm" placeholder="{{HotSearchingContent}} ↵" style="font-size:13px;min-width:240px;border-radius:3px;font-size:12px;border:none;outline:none"></div></form><li class="dropdown text-center"><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img class="img-circle header-user-avatar" src="'.$useravatar.'"/>'.$username.'<span class="caret"></span></a><ul class="dropdown-menu navbar-right user_nav_bar"><li ng-class="{active:NowShowPage==21}"><a ui-sref="myhome"><span class="glyphicon glyphicon-home spanicon"></span>个人主页</a></li><!--<li ng-class="{active:MyRoomActivity==1}"><a ng-click="navactivitify(2)"><span class="glyphicon glyphicon-flag spanicon"></span>我的房间</a></li><li ng-class="{active:BlogActivity==1}"><a ui-sref="blog" ng-click="navactivitify(3)"><span class="glyphicon glyphicon-file spanicon"></span>我的文章</a></li>--><li ng-class="{active:NowShowPage==22}"><a ui-sref="info_setting"><span class="glyphicon glyphicon-cog spanicon"></span>设置</a></li><li><a ng-click="logout()"><span class="glyphicon glyphicon-log-out spanicon"></span>退出登录</a></li><li role="separator" class="divider"></li><li class="dropdown-header">个人操作</li><li class="queue-list '.$openstatus_bar_class.'"><a ng-click="openteamornot()" data-toggle="tooltip" data-placement="bottom" title="开放组队状态下，您的消息将出现在玩家列表，其它人会找到您。"><span class="glyphicon glyphicon-off spanicon"></span>开放组队</a></li><!--<li role="separator" class="divider"></li><li class="dropdown-header">房间操作</li><li><a href="" data-toggle="tooltip" data-placement="bottom">完全开放</a></li><li><a href="" data-toggle="tooltip" data-placement="bottom">设密开放</a></li><li><a href="" data-toggle="tooltip" data-placement="bottom" title="">隐藏房间</a></li></ul></li>--></ul></div></div></nav>';
/********************************************************End*/
