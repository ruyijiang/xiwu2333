...
$header_unregistered = '<nav class="navbar navbar-inverse navbar-fixed-top xw-topbar"><div class="container"><div class="navbar-header"><a class="navbar-brand" ui-sref="main" style="margin-right:20px;"><strong>喜屋</strong></a></div><div id="navbar" class="collapse navbar-collapse"><ul class="nav navbar-nav"><li ng-class="{active:MainPageActivity==1}"><a ui-sref="main">首页</a></li><li ng-class="{active:UserListActivity==1}"><a ui-sref="userlist">玩家列表</a></li><li ng-class="{active:RoomListActivity==1}"><a ui-sref="roomlist">房间列表</a></li></ul><ul class="navbar-right nav navbar-nav"><li ng-class="{active:LoginActivity==1}"><a class="pull-left active" ui-sref="login">登陆</a></li><li ng-class="{active:SignupAcivity==1}"><a class="pull-left" ui-sref="signup">注册</a></li><li><a class="pull-left" ui-sref="activation">激活邀请码</a></li></div></nav>';

//********header-registered*********//登陆了的用户的头部
//里面还有几个和用户相关的变量,该变量需要获取用户信息之后才能填写
//也就是说，必须先获取用户信息，$header_registered才能正常使用//
@$header_registered = '<nav class="navbar navbar-inverse navbar-fixed-top xw-topbar"><div class="container"><div class="navbar-header"><a class="navbar-brand" ui-sref="main"><strong>喜屋</strong></a></div><div id="navbar" class="collapse navbar-collapse"><ul class="nav navbar-nav"><li ng-class="{active:MainPageActivity==1}"><a ui-sref="main">首页</a></li><li ng-class="{active:UserListActivity==1}"><a href="userlist.php" ui-sref="userlist">玩家列表</a></li><li ng-class="{active:RoomListActivity==1}"><a ui-sref="roomlist">房间列表</a></li></ul><ul class="navbar-right nav navbar-nav"><li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img class="img-circle header-user-avatar" src="'.$useravatar.'"/>'.$username.'<span class="caret"></span></a><ul class="dropdown-menu navbar-right user_nav_bar"><li ng-class="{active:MyHomeActivity==1}"><a ui-sref="myhome" ng-click="navactivitify(1)"><span class="glyphicon glyphicon-home spanicon"></span>个人主页</a></li><li ng-class="{active:MyRoomActivity==1}"><a ng-click="navactivitify(2)"><span class="glyphicon glyphicon-flag spanicon"></span>我的房间</a></li><li ng-class="{active:BlogActivity==1}"><a ui-sref="blog" ng-click="navactivitify(3)"><span class="glyphicon glyphicon-file spanicon"></span>我的文章</a></li><li ng-class="{active:SettingActivity==1}"><a ui-sref="info_setting" ng-click="navactivitify(4)"><span class="glyphicon glyphicon-cog spanicon"></span>设置</a></li><li><a ng-click="logout()"><span class="glyphicon glyphicon-log-out spanicon"></span>退出登录</a></li><li role="separator" class="divider"></li><li class="dropdown-header">个人操作</li><li class="queue-list '.$openstatus_bar_class.'"><a ng-click="openteamornot()" data-toggle="tooltip" data-placement="bottom" title="开放组队状态下，您的消息将出现在玩家列表，其它人会找到您。"><span class="glyphicon glyphicon-off spanicon"></span>开放组队</a></li><li role="separator" class="divider"></li><li class="dropdown-header">房间操作</li><li><a href="" data-toggle="tooltip" data-placement="bottom">完全开放</a></li><li><a href="" data-toggle="tooltip" data-placement="bottom">设密开放</a></li><li><a href="" data-toggle="tooltip" data-placement="bottom" title="">隐藏房间</a></li></ul></li></ul></div></div></nav>';
/********************************************************End*/
