        ...
        <div class="row clearfix col-lg-4 col-sm-4">
            <form class="form-signin center-block" ng-submit="signupsubmit()">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="常用邮箱" aria-describedby="basic-addon1" name="email" autocomplete="off" ng-model="UserName">
                </div>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-option-horizontal spanicon"></span>新建密码</span>
                    <input type="password"class="form-control" aria-describedby="basic-addon1" placeholder="请输入一个常用密码" name="password" data-toggle="tooltip" data-placement="bottom" data-original-title="必须是字母和数字的组合" ng-model="UserPassword">
                </div>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-option-horizontal spanicon"></span>确认密码</span>
                    <input type="password" class="form-control" aria-describedby="basic-addon1" placeholder="重复上述密码" ng-model="UserPassword_Repeat">
                </div>
