        ...
        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12" >
          <div class="blog-post a_content_container" style="overflow: hidden; word-wrap: break-word;">
              <div class="blog_titlecontainer" style="position: relative;padding:25px 0 15px 0px;margin-bottom:25px;">
                  ...
                  <div class="blog_title_mask" style="position:absolute;right:0;top:0;width:76%;height:100%;background:linear-gradient(to left,transparent 17%,rgba(255,255,255,1) 86%);z-index:2;"></div>
                  <div class="blog_title_img" style="position:absolute;right:0;top:0;width:76%;height:100%;z-index:1">
