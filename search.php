    ...
    <div class="row">
        <div class="boat clear-fix">
            ...
            <div class="row">
                    ...
                    <div class="per_s-leftpart  boat" style="padding: 0px">
                        <ul class="nav nav-pills nav-stacked">
                            <li ng-class="{active:leftNavIndex == 1}">
                                <a ng-click="alertPri('user')">玩家<span ng-if="priority=='user'" class="badge">{{SearchContentReq.length}}</span></a>
                            </li>
                            <li ng-class="{active:leftNavIndex == 2}">
                                <a ng-click="alertPri('competition')">比赛<span ng-if="priority=='competition'" class="badge">{{SearchContentReq.length}}</span></a>
                            </li>
                            <li ng-class="{active:leftNavIndex == 3}">
                                <a ng-click="alertPri('article')">{{priority}}文章<span ng-if="priority=='article'" class="badge">{{SearchContentReq.length}}</span></a>
                            </li>
                        </ul>
                    </div><!--End of leftpart-->
                </div>
                ...
                <div ng-if="priority=='user'" style="display:block;" class="col-lg-8 col-md-9 col-xs-12 search_user_container" style="font-size:16px;">
                    <div class="col-lg-12 clearfix user_conse" ng-if="SearchContentReq[0].statuscode!=='0'" ng-repeat="xu in SearchContentReq">
                    ...
                    <div class="row text-center" ng-if="SearchContentReq[0].statuscode !== '0'">
                        <nav>
                            <ul class="pagination">
                                <li>
                ...
                <div ng-if="priority=='article'" class="col-lg-9 col-md-9 col-xs-12" style="font-size:16px;">
